/********************************************************************************
** Form generated from reading UI file 'salesreportform_new.ui'
**
...
#ifndef UI_SALESREPORTFORM_NEW_H
#define UI_SALESREPORTFORM_NEW_H
...
public:
    ...
    QComboBox *comboBox_createBackup;
    QPushButton *pushButton_createBackup;
...
""));
        ...
        comboBox_createBackup = new QComboBox(layoutWidget1);
        comboBox_createBackup->addItem(QString());
        comboBox_createBackup->addItem(QString());
        comboBox_createBackup->addItem(QString());
        comboBox_createBackup->addItem(QString());
        comboBox_createBackup->setObjectName("comboBox_createBackup");

        horizontalLayout_6->addWidget(comboBox_createBackup);

        pushButton_createBackup = new QPushButton(layoutWidget1);
        pushButton_createBackup->setObjectName("pushButton_createBackup");
        pushButton_createBackup->setStyleSheet(QString::fromUtf8("QPushButton{\n"
...
""));
        ...
        horizontalLayout_6->addWidget(pushButton_createBackup);
...
""));
    ...
    void retranslateUi(QWidget *salesreportform)
    {
        ...
        comboBox_createBackup->setItemText(0, QCoreApplication::translate("salesreportform", "Sales", nullptr));
        comboBox_createBackup->setItemText(1, QCoreApplication::translate("salesreportform", "Inventory", nullptr));
        comboBox_createBackup->setItemText(2, QCoreApplication::translate("salesreportform", "Admin", nullptr));
        comboBox_createBackup->setItemText(3, QCoreApplication::translate("salesreportform", "Cashier", nullptr));

        pushButton_createBackup->setText(QCoreApplication::translate("salesreportform", "Create Backup", nullptr));
...
#endif // UI_SALESREPORTFORM_NEW_H
