...
void BarcodeScanner::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::IndexOfMethod) {
        if (QtMocHelpers::indexOfMethod<void (BarcodeScanner::*)(const QString & )>(_a, &BarcodeScanner::barcodeScanned, 0))
            return;
    }
}
...
// SIGNAL 0
void BarcodeScanner::barcodeScanned(const QString & _t1)
{
