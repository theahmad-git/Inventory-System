...
""));
        ...
        lineEdit_cardpin = new QLineEdit(layoutWidget);
        lineEdit_cardpin->setObjectName("lineEdit_cardpin");
        lineEdit_cardpin->setStyleSheet(QString::fromUtf8("QLineEdit {\n"
"    background-color: #ECF0F1;\n"
"    color: #2C3E50;\n"
"    border: 1px solid #BDC3C7;\n"
"    border-radius: 3px;\n"
...
""));
        ...
        horizontalLayout_8->addWidget(lineEdit_cardpin);
...
""));
    ...
    void retranslateUi(QWidget *payment)
    {
        ...
        label_2->setText(QCoreApplication::translate("payment", "Card Pin:", nullptr));
